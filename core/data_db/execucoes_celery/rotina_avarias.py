...
from core.query_oracle.query_celery.rotina_avarias_db import avarias_db
import pandas as pd
import requests


def rotina_tratando_avarias():
...
def rotina_enviar_avarias():
    dados = rotina_tratando_avarias()
    token = login_api()
